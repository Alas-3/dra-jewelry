      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 max-w-4xl mx-auto">
          <div className="text-center sm:text-left col-span-1 sm:col-span-2 md:col-span-1 md:pr-8">
            ...
            <p className="text-sm">
              Crafting exquisite, custom-made jewelry for those who appreciate
              the finest things in life. Our passion for perfection shines
              through in every piece we create.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} DRA Jewelry. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
